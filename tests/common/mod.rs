...
pub fn compile_with_native<T: Compilable>(context: &Context, source: T) -> ExecutionEngine {
    let functions = vec![
        ...
        ("CONCAT_DATE_TOD", iec61131std::CONCAT_DATE_TOD as usize),
        ("CONCAT_DATE__INT", iec61131std::CONCAT_DATE__INT as usize),
        ("CONCAT_DATE__UINT", iec61131std::CONCAT_DATE__UINT as usize),
        ("CONCAT_DATE__DINT", iec61131std::CONCAT_DATE__DINT as usize),
        ("CONCAT_TOD__SINT", iec61131std::CONCAT_TOD__SINT as usize),
        ("CONCAT_TOD__USINT", iec61131std::CONCAT_TOD__USINT as usize),
        ("CONCAT_TOD__INT", iec61131std::CONCAT_TOD__INT as usize),
        ("CONCAT_TOD__UINT", iec61131std::CONCAT_TOD__UINT as usize),
        ("CONCAT_TOD__DINT", iec61131std::CONCAT_TOD__DINT as usize),
        ("CONCAT_TOD__UDINT", iec61131std::CONCAT_TOD__UDINT as usize),
        ("CONCAT_TOD__LINT", iec61131std::CONCAT_TOD__LINT as usize),
        ("CONCAT_TOD__ULINT", iec61131std::CONCAT_TOD__ULINT as usize),
        (
            "CONCAT_DATE__UDINT",
            iec61131std::CONCAT_DATE__UDINT as usize,
        ),
        ("CONCAT_DATE__LINT", iec61131std::CONCAT_DATE__LINT as usize),
        (
            "CONCAT_DATE__ULINT",
            iec61131std::CONCAT_DATE__ULINT as usize,
        ),
        (
